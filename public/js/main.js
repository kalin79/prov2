document.addEventListener("DOMContentLoaded", function () {
    ...
    function animamarBannerHome(selectorBanner) {
        ...
        console.log(selectorBanner)

        const svgs = document.querySelectorAll(`.${selectorBanner} .loaderLogoContainer .logoContainer svg`);
        ...
        const paths = document.querySelector(`.${selectorBanner} .loaderLogoContainer .flechaContainer svg path`);
        ...
        const svgsFlecha = document.querySelector(`.${selectorBanner} ` + ".loaderLogoContainer .flechaContainer svg");
        gsap.to(svgsFlecha, {
            duration: .5,
            y: 5,
            repeat: 4,    // Repite indefinidamente
        ...
        const logoContainer = document.querySelectorAll(`.${selectorBanner} ` + ".loaderLogoContainer");
        // const logoContainer = document.getElementById('bannerLogo1');
